; Mercurial Player - NSIS installer English language file

LangString welcomeText ${LANG_ENGLISH} "This program will guide you through the installation of ${PRODUCTNAME}.$\r$\n$\r$\n${PRODUCTNAME} is a local music player with a Material Design 3 (MD3) style.$\r$\n$\r$\nClick Next to continue."
LangString finishTitle ${LANG_ENGLISH} "Installation Complete"
LangString finishSubtitle ${LANG_ENGLISH} "Setup has finished"
LangString finishDescription ${LANG_ENGLISH} "Choose what to do next:"
LangString createDesktopCheckbox ${LANG_ENGLISH} "Create a desktop shortcut"
LangString createStartMenuCheckbox ${LANG_ENGLISH} "Create a Start menu shortcut"
LangString launchAppCheckbox ${LANG_ENGLISH} "Launch ${PRODUCTNAME}"
...
LangString deleteAppData ${LANG_ENGLISH} "Delete user data (settings, library, fonts, etc.)"
LangString deleteAppDataNote ${LANG_ENGLISH} "Cache (covers, metadata, WebView, etc.) is always removed."
